...
# curl -X POST "http://192.168.1.6:5000/openai-cypher" -H "Content-Type: application/json" -d "{\"query\":\" poiï¿½ï¿½i najkrajï¿½o pot med nodom tipa table in nodom tipa package \",\"task\":\"explain\",\"execute\":false}"   
...
def show_image(filename):
    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; padding: 20px;">
        ...
        <p><a href="{img_url}" download>Download</a> â€¢ <a href="/list-images">List images (JSON)</a></p>
      </body>
    </html>
    '''
